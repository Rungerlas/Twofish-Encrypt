...
public class Twofish {
   ...
   private static byte[] blockEncrypt(byte[] in, int inOffset, Object sessionKey) {
    ...
    public static synchronized Object antKey(byte[] k) {
        if (k == null) {
            return null;
        }
        try {
    ...
    public static byte[] antEncrypt(byte[] in, int inOffset, Object sessionKey) {
        if (in == null || sessionKey == null || inOffset < 0) {
            return null;
        }
        return blockEncrypt(in, inOffset, sessionKey);
    }
    public static byte[] antDecrypt(byte[] in, int inOffset, Object sessionKey) {
        if (in == null || sessionKey == null || inOffset < 0) {
            return null;
        }
